    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#" >Cadastro <span class="caret"></span></a>
        <ul class="dropdown-menu">
          ...
          <li><a href="#" onclick="return carregarServicos();"><i class="glyphicon glyphicon-shopping-cart"></i>Cliente</a></li>
          <li><a href="#" onclick="return carregarCadastroCliente();"><i class="glyphicon glyphicon-shopping-cart"></i>Serviços</a></li>
        </ul>
      </li>
...
<div id="page-wrapper">
     <form id="formCorpo">
          <iframe id="meuiframe" height="100%" src="inicio.jsp" frameborder="0" width="100%" style="margin-top: -15px">
